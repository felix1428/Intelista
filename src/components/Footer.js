  ...
  return (
	...
	<div className="lg:w-1/3">
		<div className="flex items-center justify-center w-12 h-12 rounded-full">
			<img src={must} className="flex-shrink-0 w-15 h-15 rounded-full text-gray-900 dark:text-gray-50" alt="Description" />
		</div>
			...
			<div className="space-y-3">
				...
				<ul className="space-y-1">
					...
					<li>
						...
						<li>
						<a rel="noopener noreferrer" href="http://www.w3.org/2000/svg">+91 97861 83710</a>
						</li>
					</li>
